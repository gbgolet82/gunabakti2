...
<head>
    ...
    <link rel="icon" href="{{ asset('lte/dist/img/gunabakti-logo.png') }}">
...
<body>
    <div class="container h-100">
        <div class="row h-100 justify-content-center align-item-center ">
            <div
                class="col-lg-3 bg-utama col-md-7 col-sm-12 card-none-color shadow-lg p-lg-4 p-md-4 p-sm-3 mx-3 mt-3 mb-3 align-self-center">
                {{-- <img src="{{ asset('lte/dist/img/logo1.png') }}" alt="" class="img-fluid mt-1 mb-1"
                    style="height: 50px" width="100%" &nbsp;> --}}
                {{-- <div
                    class="col-lg-12 no-bg col-md-7 col-sm-12 card-none-color shadow-lg align-self-center centered-text">
                    <h3 style="color: #218839;">gunabakti.com</h3>
                </div> --}}
            ...
            <div
                class="col-lg-5 col-md-7 col-sm-12 card-none-color shadow-lg p-lg-4 p-md-4 p-sm-3 mx-3 mb-3 align-self-center">
